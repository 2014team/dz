	...
	F.prototype.config = {
			...
			b = function() {
				...
				return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(y, function(a, l) {
					...
					var o = [],
						y = [],
						h = [],
						st = (c.config.rowStyle ? c.config.rowStyle(l) : ''),
						cd = (c.config.rowChildStyle ? c.config.rowChildStyle(l) : ''),
						p = a + s.limit * (n - 1) + 1;
					...
					}), v.push('<tr data-index="' + a + '" ' + st + '">' + o.join("") + "</tr>"+cd), m.push('<tr data-index="' + a + '"  ' + st + '">' + y.join("") + "</tr>"+cd), g.push('<tr data-index="' + a + '"  ' + st + '">' + h.join("") + "</tr>"+cd))
		...
		var v = function(e) {
			...
			return o = o[l] || {}, t.extend({
					...
					update : function(e,rowChild) {
						
						if(rowChild){
							var html='<td data-field="0"></td><td data-field="indexId" data-content=""><div class="layui-table-cell laytable-cell-1-indexId">&nbsp;&nbsp;&nbsp;&nbsp;├' + rowChild.mobile + '</div></td>  <td data-field="packageName"><div class="layui-table-cell laytable-cell-1-sort">' + rowChild.packageName + '</div></td> <td data-field="mobile"><div class="laytable-cell-1-sort">&nbsp;&nbsp;</div></td> <td data-field="sort"><div class="layui-table-cell laytable-cell-1-sort">' + rowChild.sort + '</div></td><td data-field="4" align="left" data-off="true"><div class="layui-table-cell laytable-cell-1-4"> <a class="layui-btn layui-btn-xs" lay-event="orderEdit_' + rowChild.orderId + '">编辑</a> <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="orderDel_' + rowChild.orderId + '">删除</a> </div></td>'						
							if(rowChild.minImageUrl && null != rowChild.minImageUrl){
								 html='<td data-field="0"></td><td data-field="indexId" data-content=""><div class="layui-table-cell laytable-cell-1-indexId">&nbsp;&nbsp;&nbsp;&nbsp;├' + rowChild.mobile + '</div></td>  <td data-field="packageName"><div class="layui-table-cell laytable-cell-1-sort">' + rowChild.packageName + '</div></td> <td data-field="mobile"><div class="laytable-cell-1-sort">&nbsp;&nbsp;<img src="' + rowChild.minImageUrl + '" width="50" height="50"/></div></td> <td data-field="sort"><div class="layui-table-cell laytable-cell-1-sort">' + rowChild.sort + '</div></td><td data-field="4" align="left" data-off="true"><div class="layui-table-cell laytable-cell-1-4"> <a class="layui-btn layui-btn-xs" lay-event="orderEdit_' + rowChild.orderId + '">编辑</a> <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="orderDel_' + rowChild.orderId + '">删除</a> </div></td>'						
