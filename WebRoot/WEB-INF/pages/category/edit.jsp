	...
	<div class="x-body">
		<form class="layui-form">
		  ...
		  <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="categoryName" name="categoryName"
						value="${entity.categoryName}"   lay-verify="required"
						autocomplete="off" class="layui-input" maxlength="30">
				</div>
				<div class="layui-form-mid layui-word-aux">建议30字符以内</div>
			</div>
		  ...
		  <div class="layui-form-item">
				...
				<div class="layui-form-mid layui-word-aux">小程序排序使用，越小显示越前面</div>
			</div>
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(save)', function(obj) {
             ...
             //加载动画
    			...
    			$.ajax({
    				url : '/admin/center/category/save.do',
    				type : "POST",
    				data :data,
    				dataType : "json",
