...
<body>
	<div class="x-body">
		...
		<input type="hidden" id="id" name="id" value="${entity.id }" />
			...
			<span class="x-red">*</span>库存id：
			</label>
			<div class="layui-input-inline">
				<input type="text" id="nailPictureframeId" name="nailPictureframeId"
					value="${entity.nailPictureframeId}"   lay-verify="required"
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(save)', function(obj) {
             ...
             //加载动画
    			...
    			$.ajax({
    				url : '/admin/center/nailPictureframeStockHistory/save.do',
    				type : "POST",
    				data :data,
    				dataType : "json",
