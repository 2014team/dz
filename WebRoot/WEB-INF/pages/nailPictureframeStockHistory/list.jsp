...
<!DOCTYPE html>
  <head>
  	...
  	<%@ taglib uri="/WEB-INF/tag/nailPictureframeStock.tld" prefix="nw" %>
   ...
   <body>
	...
	<script type="text/html" id="toolbar">
  		<div class="layui-btn-container">
   			 <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="delAll('rendReloadId','/admin/center/nailPictureframeStockHistory/delete/batch.do')">批量删除</button>
...
layui.use([ 'table', 'form', 'laydate' ], function() {
		...
		laydate.render({
		  ...
		  table.render({
			elem : '#table_list',
			url : '/admin/center/nailPictureframeStockHistory/list.do',
			toolbar: '#toolbar',
	 ...
	 form.on('submit(searchFilter)', function (data) {
		...
		editRowObj = obj;
			 ...
			 switch(obj.event){
			  case 'del': //删除
				orderd_delete(obj,'/admin/center/nailPictureframeStockHistory/delete.do');
		      break;
		      case 'edit':// 编辑
				x_admin_show('编辑','/admin/center/nailPictureframeStockHistory/edit/'+obj.data.id+'.do');
		      break;
			 }
		});
	});
   ...
   //刷新
	function reloadTable(id){
		...
		function editRelaod(id){
				 $.ajax({
					url : '/admin/center/nailPictureframeStockHistory/get.do',
					type : "POST",
					data :{
				            "id": id,
				            "page": "1",
