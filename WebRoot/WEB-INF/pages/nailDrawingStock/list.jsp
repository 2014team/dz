   ...
   <body>
	...
	<script type="text/html" id="toolbar">
  		<div class="layui-btn-container">
   			 <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="delAll('rendReloadId','/admin/center/nailDrawingStock/delete/batch.do')">批量删除</button>
   			  <button class="layui-btn layui-btn-sm"  onclick="x_admin_show('编辑','/admin/center/nailDrawingStock/add.do')"><i class="layui-icon"></i>增加</button>
  		</div>
	</script>
...
layui.use([ 'table', 'form', 'laydate' ], function() {
		...
		laydate.render({
		  ...
		  table.render({
			elem : '#table_list',
			url : '/admin/center/nailDrawingStock/list.do',
			toolbar: '#toolbar',
	 ...
	 form.on('submit(searchFilter)', function (data) {
		...
		editRowObj = obj;
			 ...
			 switch(obj.event){
			  case 'del': //删除
				orderd_delete(obj,'/admin/center/nailDrawingStock/delete.do');
		      break;
		      case 'edit':// 编辑
   ...
   //刷新
	function reloadTable(id){
		...
		function editRelaod(id){
				 $.ajax({
					url : '/admin/center/nailDrawingStock/get.do',
					type : "POST",
					data :{
				            "id": id,
				            "page": "1",
					...
					editRowObj.update({
							 ...
							 printSize: resp.data.printSize,
							 frameSize: resp.data.frameSize,
