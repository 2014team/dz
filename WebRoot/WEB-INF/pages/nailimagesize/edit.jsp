		  ...
		  <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="size" name="size" maxlength="11"
						value="${entity.size }"   lay-verify="required|number"
		  ...
		  <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="width" name="width" maxlength="11"
						value="${entity.width }"   lay-verify="required|number"
						autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">数字</div>
			</div>
		  <div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="height" name="height" maxlength="11"
						value="${entity.height }"   lay-verify="required|number"
						autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">数字</div>
			</div>
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(save)', function(obj) {
             ...
             //加载动画
    			...
    			$.ajax({
    				url : '/admin/center/nailimagesize/save.do',
    				type : "POST",
    				data :data,
    				dataType : "json",
