   ...
   <body>
	...
	<script type="text/html" id="toolbar">
  		<div class="layui-btn-container">
   			   <!-- <button class="layui-btn layui-btn-sm layui-btn-danger" onclick="order_delAll('rendReloadId','/admin/center/nailpictureframe/delete/batch.do')">批量删除</button>-->
   			  <button class="layui-btn layui-btn-sm"  onclick="x_admin_show('编辑','/admin/center/nailpictureframe/add.do')"><i class="layui-icon"></i>增加</button>
  		</div>
	</script>
...
layui.use([ 'table', 'form', 'laydate' ], function() {
		...
		laydate.render({
		  ...
		  table.render({
			elem : '#table_list',
			url : '/admin/center/nailpictureframe/list.do',
			toolbar: '#toolbar',
	 ...
	 form.on('submit(searchFilter)', function (data) {
		...
		editRowObj = obj;
			 ...
			 switch(obj.event){
			  case 'del': //删除
				orderd_delete(obj,'/admin/center/nailpictureframe/delete.do');
		      break;
		      case 'edit':// 编辑
				x_admin_show('编辑','/admin/center/nailpictureframe/edit/'+obj.data.id+'.do');
		      break;
			 }
		});
	});
...
function order_delAll(layfilterId,url) {
	...
	function reloadTable(id){
		...
		function editRelaod(id){
				 $.ajax({
					url : '/admin/center/nailpictureframe/get.do',
					type : "POST",
					data :{
				            "id": id,
				            "page": "1",
