...
@Controller
@RequestMapping("/admin/center/category")
public class CategoryController {
	...
	public LayUiResult save(CategoryVo entity, HttpServletRequest request) {
		LayUiResult layUiResult = new LayUiResult();

		// 参数验证
		String categoryName = entity.getCategoryName();
		if (StringUtils.isEmpty(categoryName)) {
			layUiResult.failure("类别名称不能为空");
			return layUiResult;
		}
	
		Integer result = categoryService.saveOrUpdate(entity);
	...
	public LayUiResult list(CategoryVo entity, HttpServletRequest request) {

		// 获取参数
		Integer page = Integer.valueOf(request.getParameter("page"));
		Integer limit = Integer.valueOf(request.getParameter("limit"));
		LayUiResult result = new LayUiResult(page, limit);
		result = categoryService.findByPage(entity, result);
		return result;
	}
	...
	public LayUiResult delete(Order entity, HttpServletRequest request) {
		...
		Integer delResult = categoryService.delete(id);
	...
	public LayUiResult deleteBatch(String array, HttpServletRequest request) {
		...
		boolean deleteResult = categoryService.deleteByBatch(array);
		if (deleteResult) {
			result.success();
			return result;
		}
