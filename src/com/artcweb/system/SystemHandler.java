...
public class SystemHandler {
	...
	public static final Logger logger = Logger.getLogger(SystemHandler.class);
	 ...
	 * @since JDK 1.6
	 */
	public static void property(SystemBean systemBean) throws UnknownHostException {
		...
		systemBean.setUserName(userName);
		System.out.println("计算机名:    " + computerName);
		systemBean.setComputerName(computerName);
		System.out.println("计算机域名:    " + userDomain);
		systemBean.setUserDomain(userDomain);
		System.out.println("本地ip地址:    " + ip);
		systemBean.setIp(ip);
		System.out.println("本地主机名:    " + addr.getHostName());
		systemBean.setHostName(addr.getHostName());
		...
		systemBean.setJdkVersion(props.getProperty("java.class.version"));
		logger.info("Java的类路径：    " + props.getProperty("java.class.path"));
		systemBean.setJdkPath(props.getProperty("java.home"));
	}
